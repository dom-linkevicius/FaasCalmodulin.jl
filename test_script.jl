...
blackwell_pairplot_figure = blackwell_parameter_pairplot(
    fpms_nt[:blackwell],
    fpms_nt[:blackwell_fixed],
    gs;
    save = true,
)
bhalla_pairplot_figure =
    bhalla_parameter_pairplot(fpms_nt[:bhalla], fpms_nt[:bhalla_fixed], gs; save = true)
shifman_pairplot_figure =
    shifman_parameter_pairplot(fpms_nt[:shifman], fpms_nt[:shifman_fixed], gs; save = true)
pepke_m2_pairplot_figure = pepke_m2_parameter_pairplot(
    fpms_nt[:pepke_m2],
    fpms_nt[:pepke_m2_fixed],
    gs;
    save = true,
)
