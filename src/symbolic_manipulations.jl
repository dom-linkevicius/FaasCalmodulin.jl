...
###        sol = A \ b
        ...
        CaM0  = (-CaM_t*koff_2C*koff_2N*kon_2C - CaM_t*koff_2C*koff_2N*kon_2N) / ((kon_2C + kon_2N)*(-koff_2C*koff_2N - koff_2C*kon_2N*(Ca^2) - koff_2N*kon_2C*(Ca^2) - kon_2C*kon_2N*(Ca^4)))
        CaM2C = (-CaM_t*koff_2N*kon_2C*(Ca^2)) / (-koff_2C*koff_2N - koff_2C*kon_2N*(Ca^2) - koff_2N*kon_2C*(Ca^2) - kon_2C*kon_2N*(Ca^4)) 
        CaM2N = (-CaM_t*koff_2C*kon_2N*(Ca^2)) / (-koff_2C*koff_2N - koff_2C*kon_2N*(Ca^2) - koff_2N*kon_2C*(Ca^2) - kon_2C*kon_2N*(Ca^4)) 
        CaM4  = (-CaM_t*kon_2C*kon_2N*(Ca^4))  / (-koff_2C*koff_2N - koff_2C*kon_2N*(Ca^2) - koff_2N*kon_2C*(Ca^2) - kon_2C*kon_2N*(Ca^4)) 
...
function get_bhalla_equilibrium_eqs()
    ...
    CaM0, CaM2Ca, CaM3Ca, CaM4Ca, CaM_T, Ca = @variables CaM0, CaM2Ca, CaM3Ca, CaM4Ca, CaM_T, Ca
    kon_1, koff_1, kon_2, koff_2, kon_3, koff_3 = @variables kon_1, koff_1, kon_2, koff_2, kon_3, koff_3
...
function solve_Bhalla_eq(kon_1, koff_1, kon_2, koff_2, kon_3, koff_3, Ca, CaM_T)
    ...
    CaM0   = (CaM_T*koff_1*koff_2*koff_3)       / (koff_1*koff_2*koff_3 + koff_2*koff_3*kon_1*(Ca^2) + koff_3*kon_1*kon_2*(Ca^3) + kon_1*kon_2*kon_3*(Ca^4))
    CaM2Ca = (CaM_T*koff_2*koff_3*kon_1*(Ca^2)) / (koff_1*koff_2*koff_3 + koff_2*koff_3*kon_1*(Ca^2) + koff_3*kon_1*kon_2*(Ca^3) + kon_1*kon_2*kon_3*(Ca^4))
    CaM3Ca = (CaM_T*koff_3*kon_1*kon_2*(Ca^3))  / (koff_1*koff_2*koff_3 + koff_2*koff_3*kon_1*(Ca^2) + koff_3*kon_1*kon_2*(Ca^3) + kon_1*kon_2*kon_3*(Ca^4))
    CaM4Ca = (CaM_T*kon_1*kon_2*kon_3*(Ca^4))   / (koff_1*koff_2*koff_3 + koff_2*koff_3*kon_1*(Ca^2) + koff_3*kon_1*kon_2*(Ca^3) + kon_1*kon_2*kon_3*(Ca^4)) 
...
function get_shifman_equilibrium_eqs()
    ...
    CaM0, CaM1Ca, CaM2Ca, CaM3Ca, CaM4Ca, CaM_T, Ca = @variables CaM0, CaM1Ca, CaM2Ca, CaM3Ca, CaM4Ca, CaM_T, Ca
    kon_1, koff_1, kon_2, koff_2, kon_3, koff_3, kon_4, koff_4 = @variables kon_1, koff_1, kon_2, koff_2, kon_3, koff_3, kon_4, koff_4
    ...
    sol = Symbolics.solve_for([eq1; eq2; eq3; eq4; eq6], [CaM0; CaM1Ca; CaM2Ca; CaM3Ca; CaM4Ca])

    return sol
end

function solve_Shifman_eq(kon_1, koff_1, kon_2, koff_2, kon_3, koff_3, kon_4, koff_4, Ca, CaM_T)

    CaM0   = (-CaM_T*koff_1*koff_2*koff_3*koff_4) / (-koff_1*koff_2*koff_3*koff_4 - Ca*koff_2*koff_3*koff_4*kon_1 - koff_3*koff_4*kon_1*kon_2*(Ca^2) - koff_4*kon_1*kon_2*kon_3*(Ca^3) - kon_1*kon_2*kon_3*kon_4*(Ca^4)) 
    CaM1Ca = (-Ca*CaM_T*koff_2*koff_3*koff_4*kon_1) / (-koff_1*koff_2*koff_3*koff_4 - Ca*koff_2*koff_3*koff_4*kon_1 - koff_3*koff_4*kon_1*kon_2*(Ca^2) - koff_4*kon_1*kon_2*kon_3*(Ca^3) - kon_1*kon_2*kon_3*kon_4*(Ca^4))
    CaM2Ca = (-CaM_T*koff_3*koff_4*kon_1*kon_2*(Ca^2)) / (-koff_1*koff_2*koff_3*koff_4 - Ca*koff_2*koff_3*koff_4*kon_1 - koff_3*koff_4*kon_1*kon_2*(Ca^2) - koff_4*kon_1*kon_2*kon_3*(Ca^3) - kon_1*kon_2*kon_3*kon_4*(Ca^4)) 
    CaM3Ca = (-CaM_T*koff_4*kon_1*kon_2*kon_3*(Ca^3)) / (-koff_1*koff_2*koff_3*koff_4 - Ca*koff_2*koff_3*koff_4*kon_1 - koff_3*koff_4*kon_1*kon_2*(Ca^2) - koff_4*kon_1*kon_2*kon_3*(Ca^3) - kon_1*kon_2*kon_3*kon_4*(Ca^4)) 
    CaM4Ca = (-CaM_T*kon_1*kon_2*kon_3*kon_4*(Ca^4)) / (-koff_1*koff_2*koff_3*koff_4 - Ca*koff_2*koff_3*koff_4*kon_1 - koff_3*koff_4*kon_1*kon_2*(Ca^2) - koff_4*kon_1*kon_2*kon_3*(Ca^3) - kon_1*kon_2*kon_3*kon_4*(Ca^4)) 
