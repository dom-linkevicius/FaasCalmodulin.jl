...
function faas_data_plots(faas_data, gs; w=17, h=7, save=false)
    ...
    groups = [faas_data[1:13], faas_data[14:24], faas_data[81:94]]
    ...
    if save
        CairoMakie.save("plots/data_plots.png", f, pt_per_unit=1, px_per_unit=px_per_unit,
        size=size_units)
    end
