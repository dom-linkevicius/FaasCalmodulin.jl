Blackwell_scheme = @model begin
    ...
    @dynamics begin
        Ca' =
            ...
            -kon_D * OGB5 * Ca +
            koff_D * CaOGB5 +
            -kon_Fluo4FF * Fluo4FF * Ca +
            koff_Fluo4FF * CaFluo4FF +
            -2kon_1 * CaM * Ca^2 +
            2koff_1 * CaM2Ca +
            -2kon_2 * CaM2Ca * Ca^2 +
            2koff_2 * CaM4Ca +
        ...
        CaM2Ca' =
            kon_1 * CaM * Ca^2 - koff_1 * CaM2Ca - kon_2 * CaM2Ca * Ca^2 + koff_2 * CaM4Ca
    ...
    @derived begin
        ...
        Ca_CaM ~ @. Normal(
            (2CaM2Ca + 4CaM4Ca) / CaM_t,
            (2CaM2Ca + 4CaM4Ca) / CaM_t * σ_shifman,
        )
    end
end;
...
Bhalla_scheme = @model begin
    ...
    @pre begin
        ...
        CaM₀_all =
            solve_Bhalla_eq(kon_1, koff_1, kon_2, koff_2, kon_3, koff_3, Ca_free, CaM_t)
    ...
    @dynamics begin
        ...
        CaM' = -kon_1 * CaM * Ca^2 + koff_1 * CaM2Ca
        CaM2Ca' =
            kon_1 * CaM * Ca^2 - koff_1 * CaM2Ca - kon_2 * CaM2Ca * Ca + koff_2 * CaM3Ca
        CaM3Ca' =
            kon_2 * CaM2Ca * Ca - koff_2 * CaM3Ca - kon_3 * CaM3Ca * Ca + koff_3 * CaM4Ca
    ...
    @derived begin
        F_F0 ~ @. Normal((OGB5 + Fmax_Fmin * CaOGB5) / (OGB5₀ + Fmax_Fmin * CaOGB5₀), σ_faas)
        Ca_CaM ~ @. Normal(
            (2CaM2Ca + 3CaM3Ca + 4CaM4Ca) / CaM_t,
            (2CaM2Ca + 3CaM3Ca + 4CaM4Ca) / CaM_t * σ_shifman,
        )
    end
end;
...
Shifman_scheme = @model begin
    ...
    @dynamics begin
        ...
        CaM1Ca' =
            kon_1 * CaM * Ca - koff_1 * CaM1Ca - kon_2 * CaM1Ca * Ca + koff_2 * CaM2Ca
        CaM2Ca' =
            kon_2 * CaM1Ca * Ca - koff_2 * CaM2Ca - kon_3 * CaM2Ca * Ca + koff_3 * CaM3Ca
        CaM3Ca' =
            kon_3 * CaM2Ca * Ca - koff_3 * CaM3Ca - kon_4 * CaM3Ca * Ca + koff_4 * CaM4Ca
    ...
    @derived begin
        F_F0 ~ @. Normal((OGB5 + Fmax_Fmin * CaOGB5) / (OGB5₀ + Fmax_Fmin * CaOGB5₀), σ_faas)
        Ca_CaM ~ @. Normal(
            (CaM1Ca + 2CaM2Ca + 3CaM3Ca + 4CaM4Ca) / CaM_t,
            (CaM1Ca + 2CaM2Ca + 3CaM3Ca + 4CaM4Ca) / CaM_t * σ_shifman,
        )
    end
end;
...
Pepke_m2_scheme = @model begin
    ...
    @dynamics begin
        ...
        CaM0' =
            ...
            koff_2N * CaM2N
        CaM2C' =
            kon_2C * CaM0 * Ca^2 - koff_2C * CaM2C + -kon_2N * CaM2C * Ca^2 + koff_2N * CaM4
        CaM2N' =
            kon_2N * CaM0 * Ca^2 - koff_2N * CaM2N + -kon_2C * CaM2N * Ca^2 + koff_2C * CaM4
        CaM4' =
    ...
    @derived begin
        F_F0 ~ @. Normal((OGB5 + Fmax_Fmin * CaOGB5) / (OGB5₀ + Fmax_Fmin * CaOGB5₀), σ_faas)
        Ca_CaM ~ @. Normal(
            (2CaM2C + 2CaM2N + 4CaM4) / CaM_t,
            (2CaM2C + 2CaM2N + 4CaM4) / CaM_t * σ_shifman,
        )
    end
end;
...
Faas_scheme = @model begin
    ...
    @dynamics begin
        ...
        NtNr' =
            2kon_TN * NtNt * Ca - koff_TN * NtNr - kon_RN * NtNr * Ca + 2koff_RN * NrNr
        NrNr' = +kon_RN * NtNr * Ca - 2koff_RN * NrNr
        CtCt' = -2kon_TC * CtCt * Ca + koff_TC * CtCr
        CtCr' =
            2kon_TC * CtCt * Ca - koff_TC * CtCr - kon_RC * CtCr * Ca + 2koff_RC * CrCr
    ...
    @derived begin
        ...
        F_F0 ~ @. Normal(signal, σ_faas)
        Ca_CaM ~ @. Normal(
            (NtNr + 2NrNr + CtCr + 2CrCr) / CaM_t,
            (NtNr + 2NrNr + CtCr + 2CrCr) / CaM_t * σ_shifman,
        )
    end
end;
...
Byrne_scheme = @model begin ### Byrne scheme
    ...
    @dynamics begin
        ...
        Fluo4FF' = -kon_Fluo4FF * Fluo4FF * Ca + koff_Fluo4FF * CaFluo4FF
        CaFluo4FF' = kon_Fluo4FF * Fluo4FF * Ca - koff_Fluo4FF * CaFluo4FF
        N0' = -k01_N * Ca * N0 + k10_N * N1 + -k02_N * Ca * N0 + k20_N * N2
        N1' = k01_N * Ca * N0 - k10_N * N1 + -k13_N * Ca * N1 + k31_N * N3
        N2' = k02_N * Ca * N0 - k20_N * N2 + -k23_N * Ca * N2 + k32_N * N3
        N3' = k13_N * Ca * N1 - k31_N * N3 + k23_N * Ca * N2 - k32_N * N3
        C0' = -k01_C * Ca * C0 + k10_C * C1 + -k02_C * Ca * C0 + k20_C * C2
        C1' = k01_C * Ca * C0 - k10_C * C1 + -k13_C * Ca * C1 + k31_C * C3
        C2' = k02_C * Ca * C0 - k20_C * C2 + -k23_C * Ca * C2 + k32_C * C3
        C3' = k13_C * Ca * C1 - k31_C * C3 + k23_C * Ca * C2 - k32_C * C3
    end

    @derived begin
        F_F0 ~ @. Normal((OGB5 + Fmax_Fmin * CaOGB5) / (OGB5₀ + Fmax_Fmin * CaOGB5₀), σ_faas)
        Ca_CaM ~ @. Normal(
            (N1 + N2 + 2N3 + C1 + C2 + 2C3) / CaM_t,
            (N1 + N2 + 2N3 + C1 + C2 + 2C3) / CaM_t * σ_shifman,
        )
    end
end;


Blackwell_const_names = (:tv_kon_1, :tv_Kd_1, :tv_kon_2, :tv_Kd_2);
Bhalla_const_names = (:tv_kon_1, :tv_Kd_1, :tv_kon_2, :tv_Kd_2, :tv_kon_3, :tv_Kd_3);
Shifman_const_names = (:tv_Kd_1, :tv_Kd_2, :tv_Kd_3, :tv_Kd_4);
Faas_const_names = (
    :tv_kon_TN,
    :tv_Kd_TN,
    :tv_kon_RN,
